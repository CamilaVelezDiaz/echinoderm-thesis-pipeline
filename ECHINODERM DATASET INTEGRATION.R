...
source_priority_levels <- c(
  ...
  "GBIF_QM",            # 8 — QM other invertebrates via GBIF
  "GBIF_echinodermata", # 9 — broad echinoderm pull via GBIF
  "OZCAM",              # 10 — Australian collections aggregator
  "iDigBio",            # 11 — international aggregator
  "OBIS"                # 12 — OBIS (good depth, sometimes less taxonomic detail)
)
